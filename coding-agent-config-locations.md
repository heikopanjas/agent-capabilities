...
| **Commands** ◆ | `~/.cursor/commands/*.md` — user-global, all projects (skills are the preferred alternative since v2.4; commands remain fully supported) | `.cursor/commands/*.md` — invoke via `/`; filename becomes command name; skills preferred since v2.4 — use `/migrate-to-skills` to convert if desired |
